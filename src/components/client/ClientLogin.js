...
const ClientLogin = props => {
    ...
    function handleLogin(event) {
        ...
        axios
        .post("https://anywhere-fitness-1.herokuapp.com/api/clients/login", userInfo)
            .then(response => {
                ...
                if (response.message === "Username is not in the system.") {
                    ...
                    axios
                    .post("https://anywhere-fitness-1.herokuapp.com/api/clients/login", { username: userInfo.username, password: userInfo.password })
                        .then(loginResponse => {
