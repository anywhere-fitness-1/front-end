...
const ClientSignup = props => {
    ...
    function handleSignup(event) {
        ...
        if (!inputsHaveErrors)
        {
            ...
            axios.post("https://anywhere-fitness-1.herokuapp.com/api/clients/register", { username: userInfo.username, password: userInfo.password})

                .then(response => {

                    axios.post("https://anywhere-fitness-1.herokuapp.com/api/clients/login", { username: userInfo.username, password: userInfo.password})
                        .then(loginResponse => {
