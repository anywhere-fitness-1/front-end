...
const InstructorSignup = props => {
    ...
    function handleSignup(event) {
        ...
        if (!inputsHaveErrors)
        {
            ...
            axios.post("https://anywhere-fitness-1.herokuapp.com/api/instructors/register", { username: userInfo.username, password: userInfo.password})

                .then(response => {

                    axios.post("https://anywhere-fitness-1.herokuapp.com/api/instructors/login", { username: userInfo.username, password: userInfo.password})
                        .then(loginResponse => {
            ...
            <FormDiv>
                ...
                <form name="login" onSubmit={handleSignup}>
                    ...
                    {/* Show input for instructor code if user is an instructor */}
                                ...
                                <Input name="instructorCode" type="text" placeholder="Instructor code" value={userInfo.instructorCode} onChange={handleChange} />
...
export default connect(mapStateToProps, { addUser })(InstructorSignup);